<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="/images/logo-220.png" alt=""> <span>Trang chủ quản trị</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/posts/create">
						<span class="icon">
							<a-icon type="form" :style="{width: '20px', height: '20px', margin: '0px', fontSize: '18px'}" />
						</span>
						<span class="label">Tạo mới sản phẩm</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/posts/list">
						<span class="icon">
							<a-icon type="unordered-list" :style="{width: '20px', height: '20px', margin: '0px', fontSize: '18px'}" />
						</span>
